...
function showBlur() {
    $.post('https://levi-inventory/showBlur');
}
...
function FormatAttachmentInfo(data) {
    $.post(
        "https://levi-inventory/GetWeaponData",
        JSON.stringify({
            weapon: data.name,
...
function handleAttachmentDrag() {
    ...
    $(".weapon-attachments-remove").droppable({
        ...
        drop: function(event, ui) {
            $.post(
                "https://levi-inventory/RemoveAttachment",
                JSON.stringify({
...
$(document).on("click", ".CombineItem", function(e) {
    ...
    if (combineslotData.toData.combinable.anim != null) {
        $.post(
            "https://levi-inventory/combineWithAnim",
            JSON.stringify({
        ...
        $.post(
            "https://levi-inventory/combineItem",
            JSON.stringify({
...
function optionSwitch(
    ...
    $.post(
        "https://levi-inventory/SetInventoryData",
        JSON.stringify({
...
function swap($fromSlot, $toSlot, $fromInv, $toInv, $toAmount) {
    ...
    if (fromData !== undefined && fromData.amount >= $toAmount) {
        ...
        if (
            ...
            $.post("https://levi-inventory/PlayDropSound", JSON.stringify({}));
            $.post(
                "https://levi-inventory/SetInventoryData",
                JSON.stringify({
                    fromInventory: $fromInv.attr("data-inventory"),
            ...
            if (fromData.amount == $toAmount) {
                if (
                    ...
                    $.post(
                        "https://levi-inventory/getCombineItem",
...
function InventoryError($elinv, $elslot) {
    ...
    $.post("https://levi-inventory/PlayDropFail", JSON.stringify({}));
}
...
(() => {
    ...
    Inventory.Close = function() {
        ...
        $.post("https://levi-inventory/CloseInventory", JSON.stringify({}));
